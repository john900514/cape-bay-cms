...
class ConversionsCrudController extends CrudController
{
    ...
    public function setup()
    {
        ...
        |--------------------------------------------------------------------------
        */
        $this->crud->setModel('App\ExternalModels\Morning\mySQL\Conversions');
        $this->crud->setRoute(config('backpack.base.route_prefix') . '/reports/morning/payment-conversions');
