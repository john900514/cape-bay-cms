...
return [
    ...
    */
    ...
    // Menu logos
    'logo_lg'   => '<img src="'.env('APP_URL').'/img/anchorCMSLogo.png" style="width:75%;">',
    'logo_mini' => '<img src="'.env('APP_URL').'/img/anchorCMSLogo.png" style="width:75%;">',

    // Developer or company name. Shown in footer.
    'developer_name' => 'Angel Gonzalez',

    // Developer website. Link in footer.
    'developer_link' => 'http://capeandbay.com',
    ...
    */
    ...
    'user_model_fqn' => App\BackpackUser::class,
